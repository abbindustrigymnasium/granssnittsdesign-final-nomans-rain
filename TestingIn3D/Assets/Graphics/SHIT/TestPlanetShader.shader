...
Shader "Celestial/Earth"
{
	...
	{
		[Header(Flat Terrain)]
		_ShoreColorLow ("Shore Color Low", Color) = (1,1,1,1)
		_ShoreColorHigh ("Shore Color High", Color) = (1,1,1,1)

		_BiomeALow ("Biome A Low", Color) = (1,1,1,1)
		_BiomeAHigh ("Biome A High", Color) = (1,1,1,1)

		_BiomeBLow ("Biome B Low", Color) = (1,1,1,1)
		_BiomeBHigh ("Biome B High", Color) = (1,1,1,1)

		_BiomeCLow ("Biome C Low", Color) = (1,1,1,1)
		_BiomeCHigh ("Biome C High", Color) = (1,1,1,1)

		_BiomeDLow ("Biome D Low", Color) = (1,1,1,1)
		_BiomeDHigh ("Biome D High", Color) = (1,1,1,1)

		_MountainLow ("Steep Low", Color) = (1,1,1,1)
		_MountainHigh ("Steep High", Color) = (1,1,1,1)
